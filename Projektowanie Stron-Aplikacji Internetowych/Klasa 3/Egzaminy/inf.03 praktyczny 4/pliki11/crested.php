...
<body>
    ...
    <main>
        ...
        <section id="główny">
            ...
            <?php
            $query = "SELECT DISTINCT swinki.data_ur, swinki.miot, rasy.rasa FROM swinki INNER JOIN rasy ON swinki.rasy_id = rasy.id WHERE swinki.rasy_id = 7;";
            $result = $conn->query($query);
            ...
            <?php
            $query = "SELECT swinki.imie, swinki.cena, swinki.opis FROM swinki WHERE swinki.rasy_id = 7;";
