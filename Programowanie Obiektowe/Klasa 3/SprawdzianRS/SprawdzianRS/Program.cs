...
using SprawdzianRS.src.Services;
    ...
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            /*Console.WriteLine("\nSprawdzanie dostępu do różnych zasobów:");
              Console.WriteLine("Read: " + rbacSystem.HasPermission(user, Permission.Read)); Console.WriteLine("Write: " + rbacSystem.HasPermission(user, Permission.Write)); Console.WriteLine("Delete: " + rbacSystem.HasPermission(user, Permission.Delete));*/
        }
    }
}